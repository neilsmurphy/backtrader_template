...
# RunBacktest Backtrader Template
This is a template I use to create new environments for onboarding clients. I find 
this makes working with Backtrader easier. 

# Installation
Follow these steps to install and run a basic backtest. 
1. Clone the repo to your local machine. 
   - HTTPS: ```git clone https://github.com/neilsmurphy/RunBacktest_Backtrader_Template.
     git```
   Then enter your user name and password.
   - SSH: ```git@github.com:neilsmurphy/RunBacktest_Backtrader_Template.git```
